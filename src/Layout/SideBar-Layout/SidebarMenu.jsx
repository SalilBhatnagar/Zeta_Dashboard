...
import SidebarMenuItems2 from './sidebarFotterSettingMenuitemx';
  ...
  return (
    <Fragment>
      <nav className="sidebar-main">
        ...
        <div id="sidebar-menu"
          style={
            wrapper.split(' ').includes(' -wrapper')
              ? { marginLeft: margin + 'px' }
              : { margin: '0px' }
          }>
          <SidebarMenuItems setMainMenu={setMainMenu} props={props} sidebartoogle={sidebartoogle} setNavActive={setNavActive} />
          <SidebarMenuItems2 setMainMenu={setMainMenu} props={props} sidebartoogle={sidebartoogle} setNavActive={setNavActive} />
