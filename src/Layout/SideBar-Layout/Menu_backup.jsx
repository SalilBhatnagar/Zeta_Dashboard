...
export const MENUITEMS = [
    ...
    },
    {
        menutitle: 'Dashboard',
        Items: [
            { path: `${process.env.PUBLIC_URL}/filemanager`, bookmark: true, icon: FilemanagerSvg, title: 'Dashboard', type: 'link' }
        ]
    },
    {
        menutitle: 'Hero banner',
        Items: [
            { path: `${process.env.PUBLIC_URL}/filemanager`, bookmark: true, icon: FilemanagerSvg, title: 'Hero Banner', type: 'link' }
        ]
    },
    {
        menutitle: 'Abandoned Cart',
        Items: [
            { path: `${process.env.PUBLIC_URL}/filemanager`, bookmark: true, icon: FilemanagerSvg, title: 'Abandoned cart', type: 'link' }
        ]
    },    
    {
        menutitle: 'Bulk Download',
        Items: [
            { path: `${process.env.PUBLIC_URL}/filemanager`, bookmark: true, icon: FilemanagerSvg, title: 'Bulk Download', type: 'link' }
        ]
    },
    {
        ...
        Items: [
            {
                title: 'Doctor WorkBench', icon: HomeSvg, type: 'sub', badge: true, active: false, children: [
                    { path: `${process.env.PUBLIC_URL}/dashboard/default`, title: 'Consultation', type: 'link' },
                    { path: `${process.env.PUBLIC_URL}/dashboard/ecommerce`, title: 'List Product', type: 'link' },
                    { path: `${process.env.PUBLIC_URL}/dashboard/crypto`, title: 'List Doctors', type: 'link' },
                ]
            },
        ]
    },
        ...
        Items: [
            {
                title: 'Web widgets', icon: HomeSvg, type: 'sub', badge: true, active: false, children: [
                    { path: `${process.env.PUBLIC_URL}/dashboard/default`, title: 'add', type: 'link' },
                    { path: `${process.env.PUBLIC_URL}/dashboard/ecommerce`, title: 'List', type: 'link' },
                ]
            },
        ]
    },
