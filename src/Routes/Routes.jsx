...
import KapivaNavLink from '../Layout/SideBar-Layout/kapiva_link';
import KapivaDashboar from '../Layout/custom/dashboard';
import KapivaHeroBanner from '../Layout/custom/herobanner';
import KapivaAbandonedCart from '../Layout/custom/abandonedCart';
import KapivaBulkDownload from '../Layout/custom/bulkDownload';
import KapivaDoctorConsultation from '../Layout/custom/doctorConsultation';
import KapivaListDoctor from '../Layout/custom/doctorWorkbench_listDoctor';
import KapivaDoctorListProduct from '../Layout/custom/doctorWorkbench_listProduct';
import KapivaWebwidgetAdd from '../Layout/custom/webWidget_add';
import KapivaWebWidgetList from '../Layout/custom/webWidget_list';
import KapivaTimerAdd from '../Layout/custom/timerWidget_add';
import KapivaTimerList from '../Layout/custom/timerWidget_list';
import RecommendedFitWidget_add from '../Layout/custom/recommendedFitWidget_add'
import AddVisitor from '../Layout/custom/AddVisitor';
import ListVisitors from '../Layout/custom/ListVisitors';
export const routes = [
    { path: `${process.env.PUBLIC_URL}/dashboard/default/`, Component: <Default /> },
    // custom route starts
    { path: `${process.env.PUBLIC_URL}${KapivaNavLink.addvisitor}`, Component: <AddVisitor/> },
    { path: `${process.env.PUBLIC_URL}${KapivaNavLink.listvisitors}`, Component: <ListVisitors/> },
    { path: `${process.env.PUBLIC_URL}${KapivaNavLink.dashboard}`, Component: <KapivaDashboar/> },
    { path: `${process.env.PUBLIC_URL}${KapivaNavLink.heroBanner}`, Component: <KapivaHeroBanner/> },
    { path: `${process.env.PUBLIC_URL}${KapivaNavLink.AbandonedCart}`, Component: <KapivaAbandonedCart/> },
    { path: `${process.env.PUBLIC_URL}${KapivaNavLink.bulkDownload}`, Component: <KapivaBulkDownload/> },
    { path: `${process.env.PUBLIC_URL}${KapivaNavLink.doctorConsultation}`, Component: <KapivaDoctorConsultation/> },
    { path: `${process.env.PUBLIC_URL}${KapivaNavLink.doctorListDoctor}`, Component: <KapivaListDoctor/> },
    { path: `${process.env.PUBLIC_URL}${KapivaNavLink.doctorListProduct}`, Component: <KapivaDoctorListProduct/> },
    { path: `${process.env.PUBLIC_URL}${KapivaNavLink.webWidgetAdd}`, Component: <KapivaWebwidgetAdd/> },
    { path: `${process.env.PUBLIC_URL}${KapivaNavLink.webWidgetList}`, Component: <KapivaWebWidgetList/> },
    { path: `${process.env.PUBLIC_URL}${KapivaNavLink.timerList}`, Component: <KapivaTimerList/> },
    { path: `${process.env.PUBLIC_URL}${KapivaNavLink.timeradd}`, Component:  <KapivaTimerAdd/>},
    { path: `${process.env.PUBLIC_URL}${KapivaNavLink.recommendedFitWidget_add}`, Component: <RecommendedFitWidget_add/> },
    // custom route limits
